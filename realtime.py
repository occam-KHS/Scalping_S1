...
def get_stock_5d_before():
    def get_stock_before(date):
        ...
        headers = {"Content-Type": "application/json",
                   ...
                   "appKey": APP_KEY,
                   "appSecret": APP_SECRET,
                   "tr_id": "VTTC8001R",  # 실전 투자 "TTTC8001R", 모의투자 "VTTC8001R"
                   "custtype": "P",
                   }
        params = {
            "CANO": '00000000',
...
async def connect():
    ### 1. 국내주식 호가, 체결가, 체결통보 ###
    code_list = [['1','H0STASP0','005930'],['1','H0STCNT0','005930'],['1','H0STCNI0','@1448985']]

    senddata_list=[]
    
    for i,j,k in code_list:
        temp = '{"header":{"approval_key": "%s","custtype":"P","tr_type":"%s","content-type":"utf-8"},"body":{"input":{"tr_id":"%s","tr_key":"%s"}}}'%(ACCESS_TOKEN,i,j,k)
        senddata_list.append(temp)
        
    while True:
        
        async with websockets.connect(URL_BASE, ping_interval=30) as websocket:
